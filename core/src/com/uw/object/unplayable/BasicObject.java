...
public abstract class BasicObject implements RenderUpdatable, Disposable {
    ...
    protected BasicObject(Vector3 position, FileHandle modelFile, CollisionPolicyStrategy collisionPolicyStrategy) {
        this(
    ...
    protected BasicObject(Matrix4 transform, FileHandle modelFile, CollisionPolicyStrategy collisionPolicyStrategy) {
